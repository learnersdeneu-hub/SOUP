// SOUP Companion field-detection dictionary.
//
// This is a real, working keyword/regex classifier — not a mocked list. It is
// deliberately heuristic rather than AI-driven: an extension's JS is fully
// inspectable by anyone who installs it, so no AI provider key can ever live
// here safely. "Ask Noodles" (the AI layer) is always handled by deep-linking
// to the authenticated SOUP web app instead, which is where such a key can
// live server-side. This dictionary can be extended over time without
// touching the scanning/filling logic in content-script.js.
//
// `group` drives the Companion progress stepper (Personal / Contact /
// Education / Documents / Review).
